...
// url fixer appends path to fix broken jekyll baseurl variable 
// https://github.com/tactivos/grunt-cdn
    ...
    buildcontrol: {
      dist: {
        options: {
          remote: 'https://github.com/mashcode/UrbanDecay.git',
          branch: 'gh-pages',
          commit: true,
          push: true
        }
  ...
  grunt.registerTask('build', [
    ...
    'concat',
    'cssmin',
// comment cdn build task for goodness sake, honestly...
    'cdn',
    'uglify',
    'imagemin',
    'svgmin',
